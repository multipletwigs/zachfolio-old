...
const ProfileSectionTimeline: () => JSX.Element = () => {
  return (
    <Flex justifyContent={"space-evenly"} mt="5">
        ...
        <TimelineBox year="2022" icon={GiPartyPopper} title="Entered Year 3 of my Bachelors of CS in Data Science ✨" description="Experienced tremendous growth in programming skills, ending the semester with 3.8 CGPA and 84 WAM."></TimelineBox>
        <TimelineBox year="Now" icon={GiMaterialsScience} title="Year 3 Semester 1 💢" description="Falling in love with programming, learning everything I can. Currently focusing on backend development with Nest.js and Tensorflow/PyTorch for AI related projects."></TimelineBox>
