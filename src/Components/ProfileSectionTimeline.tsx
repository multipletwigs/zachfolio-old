...
const ProfileSectionTimeline: () => JSX.Element = () => {
  return (
    <Flex justifyContent={"space-evenly"} mt="5">
        ...
        <TimelineBox year="2021" icon={GiPartyPopper} title="Entered Year 2 of my Bachelors of CS in Data Science ✨" description="Experienced tremendous growth in programming skills, ending the semester with 3.91 CGPA and 85.125 WAM. Theory of Computation ruined my otherwise perfect GPA and WAM :("></TimelineBox>
